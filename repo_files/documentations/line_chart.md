...
|PropName		|Description	|default value|
|:---------------|:---------------|:-------|
|show| determines whether to show or hide the bar line|true|
|spots| list of [FlSpot](base_chart.md#FlSpot)'s x and y coordinates that the line goes through| []
...
|isCurved| curves the corners of the line at the spot's positions| false|
|curveSmoothness| smoothness radius of the curve corners (works when isCurved is true) | 0.35|
|preventCurveOverShooting|prevents overshooting when drawing a curve line on linear sequence spots, check this [issue](https://github.com/imaNNeo/fl_chart/issues/25)| false|
|preventCurveOvershootingThreshold|threshold for applying the prevent overshooting algorithm | 10.0|
|isStrokeCapRound| determines whether the start and end of the bar line is Cubic or Round | false|
...
|PropName|Description|default value|
|:-------|:----------|:------------|
|show|determines whether to show or hide the below, or above bar area|false|
...
|applyCutOffY| determines whether to apply cutOffY (`cutOffY` should be provided)|false|


### BarAreaSpotsLine
|PropName|Description|default value|
|:-------|:----------|:------------|
|show|determines whether to show or hide the below, or above spots line|true|
|flLineStyle|a [FlLine](base_chart.md#FlLine) object that determines the style of the line|[Colors.blueGrey]|
...
|applyCutOffY|Determines whether to inherit the cutOff properties from its parent [BarAreaData](#BarAreaData)|true|
...
|touchTooltipData|a [LineTouchTooltipData](#LineTouchTooltipData), that determines how to show the tooltip on top of touched spots (appearance of the showing tooltip bubble)|LineTouchTooltipData|
|getTouchedSpotIndicator| a callback that retrieves a list of [TouchedSpotIndicatorData](#TouchedSpotIndicatorData) by the given list of [LineBarSpot](#LineBarSpot) for showing the indicators on touched spots|defaultTouchedIndicators|
...
### LineTouchTooltipData
 ...
 |getTooltipItems|a callback that retrieves a list of [LineTooltipItem](#LineTooltipItem) by the given list of [LineBarSpot](#LineBarSpot) |defaultLineTooltipItem|
 ...
 |getTooltipColor|a callback that retrieves the Color for each touched spot separately from the given [LineBarSpot](#LineBarSpot) to set the background color of the tooltip bubble|Colors.blueGrey.darken(15)| 
...
|PropName|Description|default value|
|:-------|:----------|:------------|
|showingSpots|Determines the spots for which each tooltip should be shown.|null|
