    ...
    data = [
      ...
      BarChartGroupData(
        ...
        barRods: [
          ...
          BarChartRodData(value: 15, rodStackItem: [
            BarChartRodStackItem(0, 6.5, dark),
      ...
      BarChartGroupData(
        ...
        barsSpace: 4,
        barRods: [
          BarChartRodData(value: 34, rodStackItem: [
      ...
      BarChartGroupData(
        ...
        barsSpace: 4,
        barRods: [
          BarChartRodData(value: 14, rodStackItem: [
            BarChartRodStackItem(0, 0.5, dark),
            BarChartRodStackItem(0.5, 12, normal),
            BarChartRodStackItem(12, 14, light),
          ], borderRadius: const BorderRadius.all(Radius.zero)),
          BarChartRodData(value: 27, rodStackItem: [
            BarChartRodStackItem(0, 7, dark),
          ...
          BarChartRodData(value: 16.5, rodStackItem: [
            BarChartRodStackItem(0, 9, dark),
            BarChartRodStackItem(9, 15, normal),
