...
class BarChartHoriSample2 extends StatefulWidget {
  BarChartHoriSample2({super.key});
  ...
  @override
  State<StatefulWidget> createState() => BarChartHoriSample2State();
}

class BarChartHoriSample2State extends State<BarChartHoriSample2> {
