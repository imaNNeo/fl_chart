...
class BarChartHoriSample1 extends StatefulWidget {
  BarChartHoriSample1({super.key});
  ...
  @override
  State<StatefulWidget> createState() => BarChartHoriSample1State();
}

class BarChartHoriSample1State extends State<BarChartHoriSample1> {
