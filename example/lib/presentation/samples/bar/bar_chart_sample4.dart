      ...
      BarChartGroupData(
        ...
        barRods: [
          ...
          BarChartRodData(
            toY: 23000000000.5,
            rodStackItems: [
              BarChartRodStackItem(0, 6000000000.5, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(6000000000.5, 18000000000, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(18000000000, 23000000000.5, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
          ...
          BarChartRodData(
            toY: 29000000000,
            rodStackItems: [
              BarChartRodStackItem(0, 9000000000, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(9000000000, 15000000000, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(15000000000, 29000000000, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
          ...
          BarChartRodData(
            toY: 32000000000,
            rodStackItems: [
              BarChartRodStackItem(0, 2000000000.5, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(2000000000.5, 17000000000.5, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(17000000000.5, 32000000000, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
      ...
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: 31000000000,
            rodStackItems: [
              BarChartRodStackItem(0, 11000000000, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(11000000000, 18000000000, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(18000000000, 31000000000, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
          ...
          BarChartRodData(
            toY: 35000000000,
            rodStackItems: [
              BarChartRodStackItem(0, 14000000000, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(14000000000, 27000000000, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(27000000000, 35000000000, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
          ...
          BarChartRodData(
            toY: 31000000000,
            rodStackItems: [
              BarChartRodStackItem(0, 8000000000, widget.dark,         '5',
                const TextStyle(),),
              BarChartRodStackItem(8000000000, 24000000000, widget.normal,         '5',
                const TextStyle(),),
              BarChartRodStackItem(24000000000, 31000000000, widget.light,         '5',
                const TextStyle(),),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
