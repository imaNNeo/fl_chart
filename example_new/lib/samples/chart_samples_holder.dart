...
class ChartSamplesHolder {
  static final Map<ChartType, List<ChartSample>> samples = {
    ChartType.line: [
      ...
      LineChartSample('Line Chart Sample 3', 'link3', (context) => const LineChartSample3()),
      LineChartSample('Line Chart Sample 4', 'link4', (context) => const LineChartSample4()),
      ...
      LineChartSample('Line Chart Sample 7', 'link7', (context) => const LineChartSample7()),
    ...
    ChartType.bar: [
      BarChartSample('Bar Chart Sample 1', 'link 1', (context) => const BarSample1()),
      BarChartSample('Bar Chart Sample 2', 'link 2', (context) => const BarSample1()),
      BarChartSample('Bar Chart Sample 3', 'link 3', (context) => const BarSample1()),
      BarChartSample('Bar Chart Sample 4', 'link 4', (context) => const BarSample1()),
    ],
    ChartType.pie: [
