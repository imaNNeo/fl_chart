...
class LineChartData extends AxisChartData with EquatableMixin {
  ...
  final LineChartScrollData lineChartScrollData;
  ...
  LineChartData({
    ...
    LineChartScrollData? lineChartScrollData,
        ...
        lineChartScrollData = lineChartScrollData ?? LineChartScrollData(),
        super(
...
class LineChartScrollData with EquatableMixin {
  final bool isEnabled;

  final double spaceBetweenXValues;

  LineChartScrollData({
    this.isEnabled = true,
    this.spaceBetweenXValues = 40,
  });

  @override
  List<Object?> get props => [isEnabled, spaceBetweenXValues];
}
