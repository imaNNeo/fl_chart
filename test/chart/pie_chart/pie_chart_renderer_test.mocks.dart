...
class MockPieChartPainter extends _i1.Mock implements _i11.PieChartPainter {
  ...
  void drawCenterSpace(
    ...
    Invocation.method(#drawCenterSpace, [canvasWrapper, centerRadius, holder]),
    returnValueForMissingStub: null,
  );
  ...
  @override
  _i2.Path createRectPathAroundLine(_i14.Line? line, double? width) =>
      (super.noSuchMethod(
  ...
  void drawSection(
    ...
    Invocation.method(#drawSection, [section, sectionPath, canvasWrapper]),
    returnValueForMissingStub: null,
  );
