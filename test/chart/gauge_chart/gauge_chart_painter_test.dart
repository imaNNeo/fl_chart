...
void main() {
  ...
  group('paint()', () {
    test('test 1', () {
      ...
      final holder = PaintHolder<GaugeChartData>(data, data, 1);
  ...
  group('drawValue()', () {
    ...
    test('with background', () {
      ...
      expect(drawArcResults[0]['use_center'], false);
      expect(drawArcResults[0]['paint_color'], MockData.color1);
      expect(drawArcResults[0]['paint_stroke_width'], data.strokeWidth);
      expect(drawArcResults[0]['paint_stroke_cap'], data.strokeCap);
  ...
  group('Range', () {
    test('test 1', () {
      expect(Range.fromValues(1, 10).contains(0.5), false);
      expect(Range.fromValues(0, 0.5).contains(0.5), true);
      expect(Range.fromValues(1, 1.5).contains(1), true);
      expect(Range.fromValues(5, 10).contains(7), true);
      expect(Range.fromValues(1, 10).contains(11), false);
      expect(Range.fromValues(1, 10).contains(0.5), false);
    });
  });

  group('DegreeAngleRange', () {
    test('test 1', () {
      expect(const DegreeAngleRange(24, 50).contains(30), true);
      expect(const DegreeAngleRange(50, 24).contains(30), true);
      expect(const DegreeAngleRange(45, -225).contains(100), false);
      expect(const DegreeAngleRange(45, -225).contains(171), true);
      expect(const DegreeAngleRange(0, 315).contains(-46), true);
    });
  });
