        ...
        BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
              ...
              color: const Color(0x00000000),
              rodStackItems: [
                BarChartRodStackItem(-5, -10, const Color(0x11111111),         '5',
                const TextStyle(),),
                BarChartRodStackItem(0, -5, const Color(0x22222222),         '5',
                const TextStyle(),),
                BarChartRodStackItem(0, 5, const Color(0x33333333),         '5',
                const TextStyle(),),
                BarChartRodStackItem(5, 10, const Color(0x44444444),         '5',
                const TextStyle(),),
              ],
            ),
          ],
