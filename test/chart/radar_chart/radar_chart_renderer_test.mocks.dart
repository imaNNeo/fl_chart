...
class MockRadarChartPainter extends _i1.Mock implements _i10.RadarChartPainter {
  ...
  double getDefaultChartCenterValue() =>
      (super.noSuchMethod(
            Invocation.method(#getDefaultChartCenterValue, []),
            returnValue: 0.0,
          )
          as double);
  ...
  double getChartCenterValue(_i13.RadarChartData? data) =>
      (super.noSuchMethod(
            Invocation.method(#getChartCenterValue, [data]),
            returnValue: 0.0,
          )
          as double);
  ...
  double getScaledPoint(
    ...
    _i13.RadarChartData? data,
      ...
      (super.noSuchMethod(
            Invocation.method(#getScaledPoint, [point, radius, data]),
            returnValue: 0.0,
          )
          as double);
  ...
  double getFirstTickValue(_i13.RadarChartData? data) =>
      (super.noSuchMethod(
            Invocation.method(#getFirstTickValue, [data]),
            returnValue: 0.0,
          )
          as double);
  ...
  double getSpaceBetweenTicks(_i13.RadarChartData? data) =>
      (super.noSuchMethod(
            Invocation.method(#getSpaceBetweenTicks, [data]),
            returnValue: 0.0,
          )
          as double);
  ...
  void drawGrids(
    ...
    Invocation.method(#drawGrids, [canvasWrapper, holder]),
    returnValueForMissingStub: null,
  );
  ...
  double radarCenterY(_i2.Size? size) =>
      (super.noSuchMethod(
            Invocation.method(#radarCenterY, [size]),
            returnValue: 0.0,
          )
          as double);
  ...
  double radarCenterX(_i2.Size? size) =>
      (super.noSuchMethod(
            Invocation.method(#radarCenterX, [size]),
            returnValue: 0.0,
          )
          as double);
  ...
  double radarRadius(_i2.Size? size) =>
      (super.noSuchMethod(
            Invocation.method(#radarRadius, [size]),
            returnValue: 0.0,
          )
          as double);
