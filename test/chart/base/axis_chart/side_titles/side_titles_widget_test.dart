...
void main() {
  ...
  final lineChartDataWithAllTitles = lineChartDataBase.copyWith(
    titlesData: FlTitlesData(
      show: true,
      leftTitles: AxisTitles(
        axisName: const Text('Left Titles'),
        sideTitles: SideTitles(
          showTitles: true,
          getTitles: (double value, TitleMeta meta) {
      ...
      topTitles: AxisTitles(
        axisName: const Text('Top Titles'),
        sideTitles: SideTitles(
          showTitles: true,
          getTitles: (double value, TitleMeta meta) {
      ...
      rightTitles: AxisTitles(
        axisName: const Text('Right Titles'),
        sideTitles: SideTitles(
          showTitles: true,
          getTitles: (double value, TitleMeta meta) {
      ...
      bottomTitles: AxisTitles(
        axisName: const Text('Bottom Titles'),
        sideTitles: SideTitles(
          showTitles: true,
          getTitles: (double value, TitleMeta meta) {
  ...
  final barChartDataWithOnlyBottomTitles = BarChartData(
    ...
    titlesData: FlTitlesData(
      ...
      rightTitles: AxisTitles(),
      bottomTitles: AxisTitles(
        axisName: const Icon(Icons.check),
        sideTitles: SideTitles(
          showTitles: true,
  ...
  final barChartDataWithOnlyRightTitles = BarChartData(
    ...
    titlesData: FlTitlesData(
      ...
      topTitles: AxisTitles(),
      rightTitles: AxisTitles(
        axisName: const Icon(Icons.arrow_right),
        sideTitles: SideTitles(
          showTitles: true,
          interval: 1,
          getTitles: (value, meta) {
